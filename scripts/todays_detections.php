...
if(isset($_GET['ajax_detections']) && $_GET['ajax_detections'] == "true"  ) {
  ...
  while($todaytable=$result0->fetchArray(SQLITE3_ASSOC))
  {
    ...
    $engname = str_replace(' ', '_', get_com_en_name($todaytable['Sci_Name']));
  ...
  ?>
        <?php if(isset($_GET['display_limit']) && is_numeric($_GET['display_limit'])){ ?>
          ...
          <b><a class="a2" href="https://allaboutbirds.org/guide/<?php echo $engname;?>" target="top"><?php echo $todaytable['Com_Name'];?></a></b><img style="height: 1em;cursor:pointer" title="View species stats" onclick="generateMiniGraph(this, '<?php echo $comname; ?>')" width=25 src="images/chart.svg"><br>
        ...
        <?php } else { //legacy mode ?>
          ...
          <div>
            ...
            <div>
            <b><a class="a2" <?php if($_GET['kiosk'] == false){?>href="https://allaboutbirds.org/guide/<?php echo $engname;?>"<?php } else {echo "style='color:blue;'";} ?> target="top"><?php echo $todaytable['Com_Name'];?></a></b>
                <?php
